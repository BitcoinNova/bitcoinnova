...
-   `mkdir -p bitcoinnova/build`
-   `cd bitcoinnova/build`
-   `cmake3 ..`
-   `make`
...
-   `MSBuild BitcoinNova.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild BitcoinNova.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`
...
[^ Return To Top](#compiling-bitcoinnova-cash)
